...
.morloc.source("/home/dev/.local/share/morloc/src/morloc/plane/default/vector-r/R/vector.R")
mlc_schema_table = list( "<list>t2<integer>j<integer>j"
, "<logical>b"
, "<numeric>a:0<numeric>f8"
, "<numeric>a:3<numeric>f8"
, "<numeric>a:4<numeric>f8"
, "<numeric>a:8<numeric>f8"
, "<numeric>a:1<numeric>f8"
, "<numeric>a:6<numeric>f8" )
...
{
    n1 <- morloc_ones1(1L)
    return(morloc_put_value(n1, mlc_schema_table[[7]]))
}
m1843 <- function()
{
    n1 <- morloc_ones1(3L)
...
.dispatch <- list()
.dispatch[[1L]] <- m1
.dispatch[[1547L]] <- m1547
.dispatch[[1734L]] <- m1734
.dispatch[[1744L]] <- m1744
.dispatch[[1757L]] <- m1757
.dispatch[[1769L]] <- m1769
.dispatch[[1824L]] <- m1824
.dispatch[[1833L]] <- m1833
.dispatch[[1843L]] <- m1843
.dispatch[[1853L]] <- m1853
.dispatch[[1899L]] <- m1899
.dispatch[[1908L]] <- m1908
.dispatch[[1918L]] <- m1918
.dispatch[[1928L]] <- m1928
